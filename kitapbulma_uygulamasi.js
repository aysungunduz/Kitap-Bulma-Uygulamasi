...
let kitap2 = { isim: "Hiçbir Karşılaşma Tesadüf Değildir", yazar: "Hakan Mengüç", fiyat: 46, raf: "2.5.RAF" }
...
let kitap5 = { isim: "Şeker Portakalı", yazar: "Jose Mouro de Vasconcelos", fiyat: 25, raf: "5.2.RAF" }
...
rafOlustur();
    ...
    alert("Girdiginiz kitap kutuphanemizde bulunmamaktadir.")
}